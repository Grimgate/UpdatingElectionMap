...
var initMap = function() {
  ...
  if (agent.indexOf("MSIE") != -1) g_map_isIE9 = true;
...
var onMouseMove = function(e) {
  ...
  if (highState != null) highState.mouseIn();
};
...
var renderLoop = function() {
  var highState = null;
  for (var i in g_StateMap) {
    if (!g_StateMap[i].highlighted) g_StateMap[i].draw();
    else highState = g_StateMap[i];
  }
  if (highState != null) {
    highState.draw();
  }
...
State.prototype.draw = function() {
  ...
  if (this.highlighted) borderColor = this.colorBorderHighlight;
  else borderColor = this.colorBorder;
  ...
  for (var i = 0; i < this.polys.length; ++i) {
    ...
    for (var j = 0; j < this.polys[i].ptX.length; ++j) {
      ...
      if (j == 0) g_map_context.moveTo(x, y);
      else g_map_context.lineTo(x, y);
    }
...
State.prototype.updateColor = function(highlight) {
  ...
  else this.renderCount = this.gradientOffset;
};
...
var inittheStates = function() {
  ...
  theStates.push(
    new State("DC", "DISTRICT OF COLUMBIA", "District of Columbia", ++i)
  );
